...
Si configuraste `MYSQLHOST=mysql.railway.internal` y `/ready` sigue en rojo, revisa `databaseConfig.missingSeparateKeys`: debe quedar vacío. Si aparecen variables faltantes, agrégalas en el servicio web de Railway (no solo en el servicio MySQL).
